...
clasteredSmallMolecules <- ONION::clasterUsingOntology(pathToFile = pathToFileWithChebiIds, header = TRUE, ontologyRepresentatnion = ONION::firstExistsInReactomeChebiOntology)
head(clasteredSmallMolecules)`  
Results are presented below:

```{r, echo=FALSE, results='asis'}
clasteredSmallMolecules <- ONION::clasterUsingOntology(pathToFile = paste(find.package("ONION"),"/example/nm-lipidomics.txt", sep = ""),
                                header = TRUE, ontologyRepresentatnion = ONION::firstExistsInReactomeChebiOntology)
knitr::kable(head(clasteredSmallMolecules, 6))
```
...
`ONION::mergeChEBIOntologyWithChildFavoring(clasteredSmallMolecules)`
...
### clasterUsingOntology()
ONION::clasterUsingOntology(pathToFile, header=TRUE, ontologyRepresentatnion)
