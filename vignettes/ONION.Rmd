...
```{r, echo=FALSE, results='asis'}
head(chebiIdsToReactomePathwaysWithRoot$ontologyId, 5)
# TODO : Convert root to character in code of ONION.
head(as.character(chebiIdsToReactomePathwaysWithRoot$root), 5)
chebiIdsToReactomePathwaysWithRoot$ensembleIds[[5]]
chebiIdsToReactomePathwaysWithRoot$uniProtIds[[5]]
chebiIdsToReactomePathwaysWithRoot$reactomeIds[[5]]
chebiIdsToReactomePathwaysWithRoot$genesSymbolsFromEnsemble[[5]]
chebiIdsToReactomePathwaysWithRoot$genesSymbolsFromUniProt[[5]]
