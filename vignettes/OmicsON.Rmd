...
i. [OmicsON workflow](#omicson-workflow)
  ...
  * 3. [Cluster molecules with ChEBI Ontology](#chebi-ontology)
  * 4. [Map molecules on Reactome](#use-reactome)
  * 5. [Expand gene clusters with STRING DB](#use-string-db)
  * 6. [Define group](#define-goups)
  * 7. [Lalalala lala](#define-groups-of-genes-and-metabolites)
  * 8. [Multivariate Statistical Analysis](#statistical-analysis)
...
It is important to set up OmicsON. You have to download mapping files from 

### Data input
To start work with OmicsON you need to provide two 'omics' data sets in data frame form. DF can be created from files as in \extdata directory under package insallation directory. This files are in tab delimited files with headers (colnames and rownames). Files are named `nm-transcriptomics.txt` and `nm-lipidomics.txt`.
